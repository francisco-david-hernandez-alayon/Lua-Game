-- core/game/world_data/npcs/test_npcs.lua
...
return {
    makeDialogueTestNpc("npc_1_map_test", "npc_5_map_test", "map_test"),
    makeSimpleTalkTestNpc("npc_2_map_test",  "map_test"),
    makeSimpleTalkTestNpc("npc_1_map_test2",  "map_test2"),
    makeSimpleTalkTestNpc("npc_2_map_test2", "map_test2"),
}